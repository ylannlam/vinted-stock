...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState(() => {
    ...
    const validTabs = [TAB_TOUT, TAB_A_RECEVOIR, TAB_A_ENVOYER, TAB_A_ENVOYER_LOT, TAB_ENVOYES, TAB_COMPTES_VINTED, TAB_WORKSPACE, TAB_EMPLOYEES, TAB_FONDS, TAB_CONNEXIONS, TAB_PROXIES]
  ...
  // Stock / Admin: full UI
  const isSpecialTab = activeTab === TAB_TOUT || activeTab === TAB_A_RECEVOIR || activeTab === TAB_A_ENVOYER || activeTab === TAB_A_ENVOYER_LOT || activeTab === TAB_ENVOYES || activeTab === TAB_COMPTES_VINTED || activeTab === TAB_EMPLOYEES || activeTab === TAB_FONDS || activeTab === TAB_CONNEXIONS || activeTab === TAB_PROXIES
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {activeTab === TAB_PROXIES && isAdmin && <ProxiesTab />}
      ...
      {activeTab !== TAB_COMPTES_VINTED && activeTab !== TAB_EMPLOYEES && activeTab !== TAB_FONDS && activeTab !== TAB_A_RECEVOIR && activeTab !== TAB_CONNEXIONS && activeTab !== TAB_PROXIES && (
        <Gallery
          items={filteredItems}
      ...
      {activeTab !== TAB_COMPTES_VINTED && activeTab !== TAB_EMPLOYEES && activeTab !== TAB_FONDS && activeTab !== TAB_A_ENVOYER && activeTab !== TAB_A_ENVOYER_LOT && activeTab !== TAB_ENVOYES && activeTab !== TAB_CONNEXIONS && activeTab !== TAB_PROXIES && (
        <button
